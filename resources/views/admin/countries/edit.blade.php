  ...
  <div class="card-body">
    <form class="" action="{{ route('admin.countries.update', [$country->id])}}" method="post" name="formCountry" id="formCountry">
      <div class="form-group">
        ...
        <input type="text" name="name"  value="{{$country->name}}" id="name" class="form-control" placeholder="Introdusca el nombre del Pais" required>
      </div>
      <div class="row">
        <div class="form-group col-md-6">
          <label for="hashtag" class="control-label">Codigo <span class="text-danger">*</span></label>
          <input type="text" name="code"  value="{{$country->code}}" id="hashtag" class="form-control" placeholder="Introdusca el Codigo del Pais" required>
        </div>
        <div class="form-group col-md-6">
