  ...
  <div class="card-body">
    <form class="" action="{{ route('admin.categories.store')}}" method="post" name="formCategory" id="formCategory">
      <div class="form-group">
        ...
        <input type="text" name="name"  value="" id="name" class="form-control" placeholder="Introdusca el nombre de la Categoria" required>
      </div>
      <div class="row">
        <div class="form-group col-md-6">
          <label for="hashtag" class="control-label">Hashtag <span class="text-danger">*</span></label>
          <input type="text" name="hashtag"  value="" id="hashtag" class="form-control" placeholder="Introdusca el hashtag de la Categoria" required>
        </div>
        <div class="form-group col-md-6">
